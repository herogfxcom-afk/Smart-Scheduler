...
3. **Telegram Caching:** Telegram UI caches Mini Apps aggressively. Whenever you change the frontend and deploy, you must add `?v=timestamp` to the URL or instruct the user to physically clear their Telegram Local Database Cache.333
